...
Summary: 
The goal of this project was to implemt a multithreaded encryptor for a txt file.
the program has to read characters from an input txt file, encrypt the text and write the encypted charcaters to an output. 
